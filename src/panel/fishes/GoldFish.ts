...
export class Goldfish {
    ...
    moveHoriz() {
        if (
            this._left + this._width + PADDING > document.body.clientWidth && 
            this._left > 0
        ) {
            this.moveLeft();
        } else if (this._left - PADDING < 0) {
            this.moveRight();
        }
    ...
    moveVert() {
        if (
            this._bottom + this._height + PADDING > document.body.clientHeight &&
            this._bottom > 0
        ) {
            this.moveDown();
        } else if (this._bottom - PADDING < 0) {
            this.moveUp();
        }
